...
- `return 0;` 0 is treated as `false` in C++ and other programming languages, so if you `return` 0 at the end of your program then 
you are saying that it is **false that the program had any errors**, this may remind you of `System.exit(0);` in Java.
